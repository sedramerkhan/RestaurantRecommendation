...
class RestaurantRecommendation:
    ...
    def __init__(self, images_paths):
        ...
        self.price['affordable'] = fuzz.trapmf(
            self.price.universe, [25, 35, 45, 55])
        self.price['expensive'] = fuzz.trapmf(
            self.price.universe, [40, 60, 70, 90])
        self.price['very_expensive'] = fuzz.trapmf(
            self.price.universe, [80, 120, 150, 150])
        ...
        self.cuisine['acceptable'] = fuzz.trapmf(
            self.cuisine.universe, [3, 4.5, 5.5, 7])
        ...
        self.location['normal'] = fuzz.trapmf(
            self.location.universe, [4, 6.5, 7.5, 10])
        self.location['far'] = fuzz.trapmf(
            self.location.universe, [8, 11, 13, 15])
        self.location['very_far'] = fuzz.trimf(
            self.location.universe, [14, 20, 20])
